...
└── models.py       # Pydantic data models (Survey, Question, Response)
```
...
3. `visualizer.py` creates Plotly figures from analysis results
4. `reporter.py` renders Jinja2 template with embedded charts
